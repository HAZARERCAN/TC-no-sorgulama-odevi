# TC Doğrulama
# Kurallar:
# * 11 hanelidir. (yapıldı)
# * Her hanesi rakamsal değer içerir.(Araştırma) isdigit (yapıldı)
# * İlk hane 0 olamaz. (yapıldı)
...
# edilen sonucun 10'a bölümünden kalan, yani Mod10'u bize 11. haneyi verir.  (yapıldı)
